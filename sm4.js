...
function bigxor(a, b) {
    if (a.toString(2).length < 32 && b.toString(2).length < 32){
		return a ^ b
	}
...
function encrypt_sm4 (messsage, key, method="ecb") {
...
function decrypt_sm4 (ciphertext, key, method="ecb") {
    //密钥
    var MK = key;
    //密文
    var X = ciphertext;
...
例子
*/
// var message = new Array(0x01234567,0x89abcdef,0xfedcba98,0x76543210);
// console.log(message)
//
// //key is OK
// var key = new Array(0x01234567,0x89abcdef,0xfedcba98,0x76543210);
//
// var inciper = encrypt_sm4(message,key,"ecb");
//
// console.log("sss:"+inciper);
// console.log(inciper[0]);
//
// var other = new Array(0x681edf34,0xd206965e,0x86b3e94f,0x536e4246);
//
// var result= decrypt_sm4(other,key,"ecb");
//
//
...
{
    console.log(i);
    message = encrypt_sm4(message,key,"ecb");
    console.log(message);
}



exports.encrypt_sm4 = encrypt_sm4;
exports.decrypt_sm4 = decrypt_sm4;